...
class OrchestratorConnectionTenantAlertFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'data' => '{ "Message": "This is a random alert generated by supervisor" }',
        ];
    }
    ...
    public function randomError()
    {
        return $this->state(function (array $attributes) {
            return [
                'notification_name' => 'Supervisor.Fake',
                'severity' => 'Error',
                'data' => '{ "Message": "This is a random error alert generated by supervisor" }',
            ];
        });
    }
    ...
    public function randomWarn()
    {
        return $this->state(function (array $attributes) {
            return [
                'notification_name' => 'Supervisor.Fake',
                'severity' => 'Warn',
                'data' => '{ "Message": "This is a random warn alert generated by supervisor" }',
            ];
        });
    }
}

...
return [
    ...
    'attributes'           => [
        ...
        'elasticsearch_enabled'    => 'elasticsearch activé',
        'elasticsearch_index_configuration' => 'paramétrage de l\'index',
        'elasticsearch_url'        => 'url',
        'elasticsearch_anonymous_authentication' => 'authentification anonyme',
        'elasticsearch_username'   => 'nom d\'utilisateur',
        'elasticsearch_password'   => 'mot de passe',
        'kibana_enabled'           => 'kibana activé',
        'kibana_url'               => 'url',
        'tenants'                  => 'locataires',
    ],
];

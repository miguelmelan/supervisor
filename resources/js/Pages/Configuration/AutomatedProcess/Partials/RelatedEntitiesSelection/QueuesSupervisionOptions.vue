...
<template>
    ...
    <div class="col-span-6">
        <Toggle id="orchestrator-connection-queues-supervision"
            v-model:checked="selectedTenant.pivot.queues_supervision" :label="__('Enable')"
            :_disabled="!selectedTenant.treeviews || !Object.keys(selectedTenant.treeviews.queueDefinitions.nodes).length > 0" />
    </div>
    <div v-if="selectedTenant.treeviews && Object.keys(selectedTenant.treeviews.queueDefinitions.nodes).length > 0 && selectedTenant.pivot.queues_supervision"
    ...
    <div v-else-if="selectedTenant.pivot.queues_supervision" class="col-span-6">

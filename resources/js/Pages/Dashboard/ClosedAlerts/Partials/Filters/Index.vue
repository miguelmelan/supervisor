...
import AlertClosingDateFilter from './Alert/ClosingDate.vue';
import AlertClosingUserFilter from './Alert/ClosingUser.vue';
...
const alertFiltersCount = computed(() => {
    ...
    if (alertClosingDateRange.value && alertClosingDateRange.value.length === 2) {
        count++;
    }
    if (selectedClosingUsers.value && selectedClosingUsers.value.length > 0) {
        count++;
    }
...
const alertClosingDateRange = computed(() => props.data.alert.closingDateRange);
...
const selectedClosingUsers = computed(() => props.data.alert.selectedClosingUsers);
...
const resetAlertFilters = () => {
    alertCreationDateRange.value.splice(0, alertCreationDateRange.value.length);
    alertClosingDateRange.value.splice(0, alertClosingDateRange.value.length);
    props.data.alert.selectedClosingUsers = [];
                ...
                <div class="p-2 border border-b-0 border-gray-200">
                    <div class="grid grid-cols-4 gap-4">
                        ...
                        <SimpleFieldFilter :values="alertsProperties.component"
                            ...
                            @updated="sendPropertyUpdatedEvent" />
                        <AlertClosingDateFilter :range="alertClosingDateRange" @updated="updateAlertClosingDateRange" />
                        <AlertClosingUserFilter :values="alertsProperties.closingUser"
                            :selected-values="selectedClosingUsers"
                            @updated="sendPropertyUpdatedEvent" />
                    </div>
                </div>
            </div>
